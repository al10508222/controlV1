  ...
  <q-form ref="EntidadesForm" @submit.prevent="() => {}">
    <q-card style="width: 100%">
      <q-item>
        ...
        <q-item-section>
          <q-item-label>Ver Entidad Federativa</q-item-label>
        </q-item-section>
      </q-item>
      <q-separator />
      <div class="q-pa-sm">
        <q-card-section>
          <div class="row q-col-gutter-sm">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3">
              <q-input v-model="form.ENTIDADFEDERATIVANOMBRE" square outlined label="Nombre Entidad" :disable="true"/>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3">
              <q-input v-model="form.ENTIDADFEDERATIVAABREVIACION" square outlined label="Nombre Corto de Entidad" :disable="true"/>
            </div>
          </div>
        </q-card-section>
